...
function AssetViewModel(props) {
  ...
  self.IMAGE = "/SOGImages/" + self.ASSET + ".jpg"; //url to image file
  ...
  self.isMine = ko.computed(function() {
    if(self.ASSET == 'BTC' || self.ASSET == 'XCP' || self.ASSET== 'BITCRYSTALS') return null; //special value for BTC and XCP
